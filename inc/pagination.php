...
if (!function_exists('somnowell_pagination')) {
     ...
     */
    function somnowell_pagination($args = array(), $class = 'pagination nav')
    {
        ...
        $args = wp_parse_args(
            $args, array(
                'mid_size' => 2,
                'prev_next' => true,
                'prev_text' => __('<', 'somnowell'),
                'next_text' => __('>', 'somnowell'),
                'type' => 'array',
                'current' => max(1, get_query_var('paged')),
                'screen_reader_text' => __('Posts navigation', 'somnowell'),
            )
        );
        ...
        <nav aria-labelledby="posts-nav-label" class="my-3">
