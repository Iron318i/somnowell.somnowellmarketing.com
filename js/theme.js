...
+function ($) {
  ...
  $(document).ready(function () {
    $("#subscore").click(function () {
      ...
      if ($('input[name=q19a]:checked').val() == 'T' && $('input[name=q19b]:checked').val() == 'T' && $('input[name=q19c]:checked').val() == 'T' && $('input[name=q19d]:checked').val() == 'T') {
        count++;
      ...
      if ($('input[name=q21a]:checked').val() == 'T' && $('input[name=q21b]:checked').val() == 'T' && $('input[name=q21c]:checked').val() == 'F' && $('input[name=q21d]:checked').val() == 'T') {
        count++;
      ...
      if ($('input[name=q23a]:checked').val() == 'N' && $('input[name=q23b]:checked').val() == 'N' && $('input[name=q23c]:checked').val() == 'N' && $('input[name=q23d]:checked').val() == 'Y' && $('input[name=q23e]:checked').val() == 'Y' && $('input[name=q23f]:checked').val() == 'N') {
        count++;
      ...
      if ($('input[name=q41a]:checked').val() == 'Y' && $('input[name=q41b]:checked').val() == 'Y' && $('input[name=q41c]:checked').val() == 'Y' && $('input[name=q41d]:checked').val() == 'Y' && $('input[name=q41e]:checked').val() == 'Y') {
        count++;
      ...
      if ($('input[name=q42a]:checked').val() == 'T' && $('input[name=q42b]:checked').val() == 'T' && $('input[name=q42c]:checked').val() == 'T' && $('input[name=q42d]:checked').val() == 'T') {
        count++;
